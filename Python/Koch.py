...
x, y = intInput("Right x"), intInput("Right y")
distance = intInput("Distance")

# bug angle and graph top
...
side = 1
## Computing the three sides
while side < 4:

    thirdAngle = 2 * pi / 3
    x0 = x + distance * cos(initializationAngle + thirdAngle * side)
    y0 = y + distance * sin(initializationAngle + thirdAngle * side)
    x1 = x + distance * cos(initializationAngle + thirdAngle * (side + 1))
    y1 = y + distance * sin(initializationAngle + thirdAngle * (side + 1))
